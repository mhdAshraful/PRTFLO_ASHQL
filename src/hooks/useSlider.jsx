...
export default function horizontalLoop(items, config) {
  ...
  gsap.set(items, { // convert "x" to "xPercent" to make things responsive, and populate the widths/xPercents Arrays to make lookups faster.
    xPercent: (i, el) => {
      let w = widths[i] = parseFloat(gsap.getProperty(el, "width", "px")); //turning the elements width in to anumber
  ...
  tl.next = vars => toIndex(currentIndex + 1, vars);
  tl.previous = vars => toIndex(currentIndex - 1, vars);
